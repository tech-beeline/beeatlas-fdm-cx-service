...
public class CJService {
    ...
    @Transactional
    public CjResponseDto createNewCJ(CJTagsDto cj, Long userId) {
        validateBody(cj);
    ...
    public CJ createCJ(CJTagsDto cj, Long userId) {
        CJ newCJ = CJ.builder()
                .name(cj.getName())
